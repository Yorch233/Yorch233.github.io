...
defineProps({
  ...
  abstract: {
    type: String,
    default: "Diffusion models have demonstrated exceptional potential in monaural speech enhancement. However, estimation errors of neural network may accumulate along the sampling trajectory, ultimately leading to degradation of the sampling quality.In this letter, we propose the <strong>Mean-Inverting Schrödinger Bridge (misb)</strong>, a generative speech enhancement model based on the Schrödinger Bridge that generates high-quality clean speech in a few steps. By integrating the posterior mean information into the diffusion process, misb provides an approximate but efficient parameterization of the Schrödinger Bridge process, in order to reduce estimation errors. Furthermore, comprehensive evaluations demonstrate that misb significantly outperforms state-of-the-art generative methods across various benchmarks. "
  },
  reference: {
    type: Object,
    default: () => ([
